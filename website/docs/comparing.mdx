...
| -------------------- | --------- | --- | -------------- | -------------------- | ---------------------------------------------- | --- | ---- |
| **Jest** _(30.4.2)_  | ✅        | ✅  | _experimental_ | 293 packages         | [**~28MB**](https://pkg-size.dev/jest@30.4.2)  | ❓  | ❓   |
| **Vitest** _(4.1.6)_ | ✅        | ❌  | ✅             | 42 packages          | [**~24MB**](https://pkg-size.dev/vitest@4.1.6) | ❓  | ❓   |
| **AVA** _(8.0.0)_    | ✅        | ✅  | ✅             | 140 packages         | [**~16MB**](https://pkg-size.dev/ava@8.0.0)    | ❓  | ❓   |
| **Mocha** _(11.7.5)_ | ❌        | ✅  | ✅             | 92 packages          | [**~9MB**](https://pkg-size.dev/mocha@11.7.5)  | ❓  | ❓   |
| **uvu** _(0.5.6)_    | ❌        | ✅  | ✅             | 6 packages           | [**~558KB**](https://pkg-size.dev/uvu@0.5.6)   | ❓  | ❓   |
| 🐷 **Poku**          | ✅        | ✅  | ✅             | 1 package (**poku**) | [**~205KB**](https://pkg-size.dev/poku)        | ✅  | ✅   |
