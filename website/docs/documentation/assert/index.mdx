...
```ts
strict(true, "It's true 🧪");
strict.strictqual(1, '1', 'Poku will describe it and show an error 🐷');
// ...
```

:::tip
**Poku**'s `assert` and `strict` will use the message exactly as it is when using `describe` and `it`. <br />
