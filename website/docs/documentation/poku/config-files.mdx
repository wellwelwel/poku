...
```sh
npx poku --config='my-file.js'
npx poku --config='my-file.cjs'
npx poku --config='my-file.mjs'
npx poku --config='my-file.ts'
npx poku --config='my-file.cts'
npx poku --config='my-file.mts'
```
