...
<History
  records={[
    {
      version: '3.0.3-canary.a1456563',
      changes: [
        <>
          Remove <code>verbose</code> reporter. Its behavior is now the default
          in the <code>poku</code> reporter.
        </>,
      ],
    },
  ]}
...
- Logs errors both in real time and at the running end.
...
- To create a custom reporter, see [Custom Reporters](/docs/documentation/plugins/reporters).
