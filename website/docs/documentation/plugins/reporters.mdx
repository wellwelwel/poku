...
`createReporter` merges your event handlers with the default `poku` reporter. You only need to override the events you care about, and the rest fall back to defaults.
