...
:::tip
To test **React** components in isolation, without spinning up a real browser, use the official [**@pokujs/react**](/docs/documentation/plugins/official/react) plugin.
:::
