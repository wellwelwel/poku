...
Use [`@pokujs/multi-suite`](/docs/documentation/helpers/multi-suite) to run the suites sequentially from a single `poku.config.js`, with a scoped plugin that recreates the database only before the integration suites:
