...
:::info
I aim to present an alternative that leverages native JavaScript, not to dissuade the use of current methods 🙋🏻‍♂️
:::
...
assert(
  true,
  'Running after my previous requeriments and before the next ones 🚀'
);
