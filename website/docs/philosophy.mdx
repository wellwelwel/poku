...
That's why the limit chosen was **Node.js** version `6.x.x`.

### Current Polyfills

- `padStart`
- `fs`: callback to async methods
...
> See **mock** examples for both [**CJS**](/docs/examples/mock/cjs) and [**ESM**](/docs/examples/mock/esm) using **Poku** + [**quiblle**](https://github.com/testdouble/quibble).

<hr />

## Which Poku doesn't Pretend to be 🤚🏻

- A replacement for other test runners
