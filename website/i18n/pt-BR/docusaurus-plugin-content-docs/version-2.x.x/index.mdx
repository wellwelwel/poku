...
2. Veja [como usar **asserções**](/docs/2.x.x/tutorials/beginner). <br />
3. Em seguida, aprenda a usar o [**poku**](/docs/2.x.x/documentation/poku/include-files) para **executar todos os seus arquivos de teste** de uma só vez.

> 🧑🏻‍🔬 Precisa testar uma _API_? Verifique o [startService](/docs/2.x.x/documentation/helpers/startService) e o [startScript](/docs/2.x.x/documentation/helpers/startScript). <br />
> 🚪 Precisa lidar com processos e portas? Verifique o [kill](/docs/2.x.x/documentation/helpers/processes/kill) e o [waitForPort](/docs/2.x.x/documentation/helpers/processes/wait-for-port). <br />
> 🐳 Precisa montar e desmontar contêineres antes e depois dos testes? Verifique o [dockerfile](/docs/2.x.x/documentation/helpers/containers#dockerfile) e o [compose](/docs/2.x.x/documentation/helpers/containers#compose). <br />
> 🧠 Aqui está um [exemplo rápido que abrange a principal diferença entre os executores de teste mais comuns](/docs/2.x.x/examples/promises).
>
...
- Observe que esses exemplos usam [**ESM**](/docs/2.x.x/examples/cjs-esm), mas você também pode usar [**CJS**](/docs/2.x.x/examples/cjs-esm).
...
> Inicialmente, a [**documentação**](/docs/2.x.x/category/documentation), os [**exemplos**](/docs/2.x.x/category/examples), e o [**início rápido**](/docs/2.x.x/category/quick-tutorials) são baseados em **Node.js** e no uso de **ESM**, mas você pode usar todas as opções normalmente para **Bun** e **Deno**, incluindo **CJS**.

<hr />

### Problemas comuns

- [Prevenção de conflitos em ambientes com múltiplas plataformas instaladas](/docs/2.x.x/tutorials/cross-platform#recommendations).
- [Execução adequada de testes assíncronos no mesmo arquivo](/docs/2.x.x/examples/promises).
