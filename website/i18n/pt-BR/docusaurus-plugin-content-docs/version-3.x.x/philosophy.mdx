...
Por isso, o limite escolhido foi a versão `14.x.x` do **Node.js**.
...
> Veja exemplos de **mock** para [**CJS**](/docs/3.x.x/examples/mock/cjs) e [**ESM**](/docs/3.x.x/examples/mock/esm) usando **Poku** + [**quibble**](https://github.com/testdouble/quibble).
