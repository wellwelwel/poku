...
| -------------------- | ---------- | --- | -------------- | ------------------- | ---------------------------------------------- | --- | ---- |
| **Jest** _(30.4.2)_  | ✅         | ✅  | _experimental_ | 293 pacotes         | [**~28MB**](https://pkg-size.dev/jest@30.4.2)  | ❓  | ❓   |
| **Vitest** _(4.1.6)_ | ✅         | ❌  | ✅             | 42 pacotes          | [**~24MB**](https://pkg-size.dev/vitest@4.1.6) | ❓  | ❓   |
| **AVA** _(8.0.0)_    | ✅         | ✅  | ✅             | 140 pacotes         | [**~16MB**](https://pkg-size.dev/ava@8.0.0)    | ❓  | ❓   |
| **Mocha** _(11.7.5)_ | ❌         | ✅  | ✅             | 92 pacotes          | [**~9MB**](https://pkg-size.dev/mocha@11.7.5)  | ❓  | ❓   |
| **uvu** _(0.5.6)_    | ❌         | ✅  | ✅             | 6 pacotes           | [**~558KB**](https://pkg-size.dev/uvu@0.5.6)   | ❓  | ❓   |
| 🐷 **Poku**          | ✅         | ✅  | ✅             | 1 pacote (**poku**) | [**~190KB**](https://pkg-size.dev/poku)        | ✅  | ✅   |
...
- ~**5.3x** mais rápido que o [**Jest**](https://github.com/jestjs/jest) (v30.4.2)
- ~**4.5x** mais rápido que o [**Vitest**](https://github.com/vitest-dev/vitest) (v4.1.6)
...
- [~**150x** mais leve que o **Jest**](https://pkg-size.dev/jest@30.4.2)
- [~**125x** mais leve que o **Vitest**](https://pkg-size.dev/vitest@4.1.6)
- [~**85x** mais leve que o **AVA**](https://pkg-size.dev/ava@8.0.0)
- [~**48x** mais leve que o **Mocha**](https://pkg-size.dev/mocha@11.7.5)
- [~**2.9x** mais leve que o **uvu**](https://pkg-size.dev/uvu@0.5.6)
