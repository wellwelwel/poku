...
| 🐷 **Poku**          | ✅         | ✅  | ✅             | 1 pacote (**poku**) | [**~198KB**](https://pkg-size.dev/poku)        | ✅  | ✅   |
...
- [~**145x** mais leve que o **Jest**](https://pkg-size.dev/jest@30.4.2)
- [~**124x** mais leve que o **Vitest**](https://pkg-size.dev/vitest@4.1.6)
- [~**83x** mais leve que o **AVA**](https://pkg-size.dev/ava@8.0.0)
- [~**47x** mais leve que o **Mocha**](https://pkg-size.dev/mocha@11.7.5)
- [~**2.8x** mais leve que o **uvu**](https://pkg-size.dev/uvu@0.5.6)
