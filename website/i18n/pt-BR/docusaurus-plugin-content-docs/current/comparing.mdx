...
- ~**3.7x** mais rápido que o [**Jest**](https://github.com/jestjs/jest) (v30.2.0)
- ~**3.2x** mais rápido que o [**Vitest**](https://github.com/vitest-dev/vitest) (v4.0.8)
- ~**1.1x** _mais rápido_ que o [**Mocha**](https://github.com/mochajs/mocha) (v11.7.5) — _mesmo com isolamento por arquivos de teste_ 🚀
