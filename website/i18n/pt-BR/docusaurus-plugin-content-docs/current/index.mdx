...
[![NPM Version](https://img.shields.io/npm/v/poku/rc.svg?label=&color=70a1ff&logo=npm&logoColor=white)](https://www.npmjs.com/package/poku)
...
O **Poku** está crescendo e a <strong>versão 3</strong> está a caminho! Você já pode experimentá-la instalando o Release Candidate com `poku@rc`.

- Para conferir o que está por vir, siga o [**Issue #801**](https://github.com/wellwelwel/poku/issues/801).
- Para obter a documentação da `v2`, consulte a [**documentação da versão legada**](/docs/2.x.x).<br />
