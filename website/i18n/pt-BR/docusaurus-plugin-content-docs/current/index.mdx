...
[![NPM Version](https://img.shields.io/npm/v/poku/canary.svg?label=&color=70a1ff&logo=npm&logoColor=white)](https://www.npmjs.com/package/poku)
...
> 🐳 Precisa montar e desmontar contêineres antes e depois dos testes? Verifique o [dockerfile](/docs/documentation/helpers/containers#dockerfile) e o [compose](/docs/documentation/helpers/containers#docker-compose). <br />
...
:::note
[**tsx**](https://github.com/privatenumber/tsx) `v4.20.4` or higher recommended.
:::
