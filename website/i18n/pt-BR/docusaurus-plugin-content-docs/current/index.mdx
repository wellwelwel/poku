...
1. [Instale o **Poku**](/docs#install). <br />
...
> 🧠 Aqui está um [rápido exemplo que abrange a principal diferença entre os executores de teste mais comuns](/docs/examples/promises).
>
...
Copyright © 2024-presente [Weslley Araújo](https://github.com/wellwelwel) e **Poku** [Contribuidores](https://github.com/wellwelwel/poku/graphs/contributors).
