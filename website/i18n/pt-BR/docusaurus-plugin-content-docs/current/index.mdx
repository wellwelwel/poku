...
> 🐳 Precisa montar e desmontar contêineres antes e depois dos testes? Verifique o [dockerfile](/docs/documentation/plugins/official/containers#dockerfile) e o [compose](/docs/documentation/plugins/official/containers#docker-compose). <br />
