...
`resource.create()` detecta automaticamente o caminho do arquivo do seu módulo de recurso. Ele recebe uma função factory como primeiro argumento, ou seja, uma função que retorna o objeto de recurso com métodos.
