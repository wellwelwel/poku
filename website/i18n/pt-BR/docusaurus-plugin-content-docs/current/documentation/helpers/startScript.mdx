...
<div className='features black'>
  ...
  <div className='p'>
    <Success />
    <span>Permite **cookies** persistam (_ou não_) 🍪</span>
  </div>
  <div className='p'>
    <Success />
    <span>
  ...
  <div className='p'>
    <Success />
    <span>
      Pare de alterar seu código devido às regras do teste, você criou seu código, não o
      **Poku** 🩵
    </span>
  </div>
</div>
...
type StartScriptOptions = {
  /**
   * - Por padrão, Isso será resolvido na primeira saída do console
  ...
  verbose?: boolean;
  /**
   * Especifique um caminho de destino para iniciar o processo
   *
   * @default "./"
   */
