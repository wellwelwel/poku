...
```ts
assert(true, "É verdadeiro 🧪");
assert.strictEqual(1, '1', 'o Poku irá descrevê-lo e mostrar um erro 🐷');
// ...
```

:::tip
O `assert` do **Poku** usará a mensagem exatamente como está ao usar `describe` e `it`. <br />
