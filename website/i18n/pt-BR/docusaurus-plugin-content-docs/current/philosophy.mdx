...
Além disso, não é possível executá-lo como `node test.js` devido a avaliações, estado global ou transformações de teste, sendo necessário rodar seu teste usando o executor de teste.
