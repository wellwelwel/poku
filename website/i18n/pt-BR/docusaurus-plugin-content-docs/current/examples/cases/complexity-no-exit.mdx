...
assert.strictEqual(0, successesCode, 'Executando Testes de Integração de Sucessos');
...
assert.strictEqual(0, failuresCode, 'Executando Testes de Integração de Falhas');
```
