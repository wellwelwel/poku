...
The use of [native **JavaScript** syntax in tests](/docs/philosophy#essência-do-javascript-para-testes-) is one of the major differences between **Poku** and other test runners, which is what makes it possible to use it on multiple platforms.
