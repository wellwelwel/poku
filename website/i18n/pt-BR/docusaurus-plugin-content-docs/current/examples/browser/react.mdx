...
:::tip
Para testar componentes **React** de forma isolada, sem subir um navegador real, use o plugin oficial [**@pokujs/react**](/docs/documentation/plugins/official/react).
:::
