...
> See **mock** examples for both [**CJS**](/docs/3.x.x/examples/mock/cjs) and [**ESM**](/docs/3.x.x/examples/mock/esm) using **Poku** + [**quibble**](https://github.com/testdouble/quibble).
