...
The use of [native **JavaScript** syntax in tests](/docs/3.x.x/philosophy#javascript-essence-for-tests-) is one of the major differences between **Poku** and other test runners, which is what makes it possible to use it on multiple platforms.
