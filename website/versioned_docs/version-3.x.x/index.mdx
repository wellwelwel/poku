...
2. See [how to use **assertions**](/docs/3.x.x/tutorials/beginner). <br />
3. Then learn how to use [**Poku**](/docs/3.x.x/documentation/poku/include-files) to **run all your test files** at once.

> 🧑🏻‍🔬 Need to test an _API_? Check the [startService](/docs/3.x.x/documentation/helpers/startService) and [startScript](/docs/3.x.x/documentation/helpers/startScript). <br />
> 🚪 Need to handle processes and ports? Check the [kill](/docs/3.x.x/documentation/helpers/processes/kill) and [waitForPort](/docs/3.x.x/documentation/helpers/processes/wait-for-port). <br />
> 🐳 Need to mount and unmount containers before/after tests? Check the [dockerfile](/docs/3.x.x/documentation/helpers/containers#dockerfile) and [compose](/docs/3.x.x/documentation/helpers/containers#compose). <br />
> 🧠 Here's a [quick example covering the main difference across common test runners](/docs/3.x.x/examples/promises).
>
...
- Note that these examples use [**ESM**](/docs/3.x.x/examples/cjs-esm), but you can use [**CJS**](/docs/3.x.x/examples/cjs-esm) as well.
...
> Initially the [**documentation**](/docs/3.x.x/category/documentation), [**examples**](/docs/3.x.x/category/examples), and [**quick tutorials**](/docs/3.x.x/category/quick-tutorials) are based on **Node.js** and **ESM** usage, but you can use all the options normally for both **Bun** and **Deno**, including **CJS**.

<hr />

### Common Issues

- [Avoiding conflicts in environments with multiple platforms installed](/docs/3.x.x/tutorials/cross-platform#recommendations).
- [Properly running asynchronous tests on the same file](/docs/3.x.x/examples/promises).
