...
test('Snapshot: Serializer (Error types)', () => {
  assert.strictEqual(
...
test('Snapshot: Serializer (class instances and prototypes)', () => {
  class Foo {
    x = 1;
    y = 'hello';
  }
...
test('Snapshot: Serializer (typed arrays and binary)', () => {
  assert.strictEqual(
...
test('Snapshot: Serializer (opaque and URL types)', () => {
...
test('Snapshot: Serializer (toJSON support)', () => {
  class Money {
    constructor(
...
test('Snapshot: Serializer (sparse arrays and symbol keys)', () => {
